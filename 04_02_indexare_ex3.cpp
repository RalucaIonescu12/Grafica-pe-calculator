...
float xMin = -300, xMax = 300.f, yMin = -300.f, yMax = 300.f;
...
void CreateVBO(void)
{
	...
	for (int i = 0; i < n; ++i) {
		...
		Vertices[i * 4] = outerRadius * cos(theta);
		Vertices[i * 4 + 1] = outerRadius * sin(theta);
		Vertices[i * 4 + 2] = 0.0f;
		Vertices[i * 4 + 3] = 1.0f;
	}
	...
	for (int i = n; i < n*2; ++i) {
		float theta = 2 * M_PI * i / n;
		Vertices[i * 4] = innerRadius * cos(theta);
		Vertices[i * 4 + 1] = innerRadius * sin(theta);
		Vertices[i * 4 + 2] = 0.0f;
		Vertices[i * 4 + 3] = 1.0f;
	}
	...
	{
		15,8,7,0,8,9,0,1,9,10,1,2,10,11,2,3,11,12,3,4,12,13,4,5,13,14,5,6,14,15,6,7
	};
