...
//a=300  b=300
float
	xMin = -400, xMax = 500, yMin = -400, yMax = 500;
float
...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] = {
		...
		150.0f,  280.0f, 0.0f, 1.0f,

		//	Varfuri poligon concav;
		40.0f,  40.0f, 0.0f, 1.0f,
		150.0f, 40.0f, 0.0f, 1.0f,
		130.0f,  90.0f, 0.0f, 1.0f,
		40.0f,  50.0f, 0.0f, 1.0f,
		120.0f,  130.0f, 0.0f, 1.0f,
