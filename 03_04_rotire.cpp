...
glm::mat4 
	myMatrix, resizeMatrix, matrTransl1, matrTransl2, matrRot, matrTransl2Conc, matrTransl1Conc, matrRotConc;
...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] = {
	 ...
	 //  //  Varfuri pentru dreptunghi;
		...
		//	Varfuri pentru poligon convex;
		150.0f,  130.0f, 0.0f, 1.0f,
		300.0f, 130.0f, 0.0f, 1.0f,
		300.0f,  290.0f, 0.0f, 1.0f,
		150.0f,  190.0f, 0.0f, 1.0f,
...
void Initialize(void)
{
	...
	matrTransl1 = glm::translate(glm::mat4(1.0f), glm::vec3(-161.f, -160.f, 0.0));
	//	Translatia 2: inversa/opusa translatiei T1;
	matrTransl2 = glm::translate(glm::mat4(1.0f), glm::vec3(161.f, 160.f, 0.0));


	matrRotConc = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0.0, 0.0, 1.0));
	//	Translatia 1: centrul patratului este translatat in origine;
	matrTransl1Conc = glm::translate(glm::mat4(1.0f), glm::vec3(-161.f, -160.f, 0.0));
	//	Translatia 2: inversa/opusa translatiei T1;
	matrTransl2Conc = glm::translate(glm::mat4(1.0f), glm::vec3(161.f, 160.f, 0.0));
}
...
void RenderFunction(void)
{
	...
	codCol = 2;
	myMatrix = resizeMatrix * matrTransl2Conc * matrRotConc * matrTransl1Conc;
	glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
