...
void RenderFunction(void)
{
	...
	if (orientare==fata) {
		glPolygonMode(fata, GL_TRIANGLES);		//	Modul de desenare in functie de orientare - ex: cu fata => deseneaza conturul, invers altfel;
	
		glPolygonMode(spate, GL_POINTS);
	}
	else
	{
		glPolygonMode(fata, GL_POINTS);  
		glPolygonMode(spate, GL_LINE);
	}
